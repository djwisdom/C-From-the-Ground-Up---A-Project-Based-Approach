...
<p align="center">
  <a href="https://github.com/dunamismax/c-from-the-ground-up">
    <img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&size=24&pause=1000&color=3071A4&center=true&vCenter=true&width=1000&lines=C+From+The+Ground+Up+Learning+Course;Complete+Project+Based+C+Curriculum;From+Hello+World+to+Systems+Programming;Learn+By+Building+Real+World+Applications;Memory+Safe+C+Development+Practices;Single+File+Lessons+with+Complete+Code;Build+Portfolio+of+Command+Line+Tools;Master+Pointers+and+Dynamic+Memory;Advanced+Terminal+UI+with+ncurses;Multithreaded+File+Processing;Socket+Programming+and+Networking;Text+Adventure+Game+Capstone+Project;Zero+Prerequisites+Beginner+Friendly;Educational+and+Open+Source+Excellence" alt="Typing SVG" />
  </a>
</p>
...
<p align="center">
  <strong>C From The Ground Up</strong><br>
  <sub>Code-First Learning • Project-Based Curriculum • Memory Safe • Zero Prerequisites • Portfolio Building</sub>
</p>
